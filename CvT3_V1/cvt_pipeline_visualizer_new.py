...
from model.HTR_3Stage import HTRModel, ImageChunker, DEFAULT_VOCAB
...
class CvTPipelineVisualizer:
    ...
    def __init__(self, model_path=None):
        ...
        if hasattr(self.model.cvt, 'patch_embed'):
            ...
            self.patch_size = self.model.cvt.stage1_embed.patch_size
            self.stride = self.model.cvt.stage1_embed.stride
